module mips_tb3;
    ...
    begin
        ...
        mips.Mem[2]  = 32'h0e940000;   // OR    R20, R20, R20 -- dummy instr.
        mips.Mem[3]  = 32'h21430000;   // LW    R3, 0(R10)
        mips.Mem[4]  = 32'h0e940000;   // OR    R20, R20, R20 -- dummy instr.
        mips.Mem[5]  = 32'h14431000;   // Loop: MUL R2, R2, R3
        mips.Mem[6]  = 32'h2c630001;   // SUBI  R3, R3, 1
        mips.Mem[7]  = 32'h0e940000;   // OR    R20, R20, R20 -- dummy instr.
